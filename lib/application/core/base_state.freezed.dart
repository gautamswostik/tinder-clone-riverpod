...
class _$BaseStateTearOff {
  ...
  BaseLoading<T> loading<T>({Map<String, dynamic>? extra}) {
    return BaseLoading<T>(
      extra: extra,
    );
  }

  BaseError<T> error<T>(String failure, {Map<String, dynamic>? extra}) {
    return BaseError<T>(
      failure,
      extra: extra,
    );
  ...
  BaseSuccess<T> success<T>(
      {T? data, Failure? failure, Map<String, dynamic>? extra}) {
...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, dynamic>? extra) loading,
    required TResult Function(String failure, Map<String, dynamic>? extra)
        error,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(Map<String, dynamic>? extra)? loading,
    TResult Function(String failure, Map<String, dynamic>? extra)? error,
    TResult Function(T? data, Failure? failure, Map<String, dynamic>? extra)?
        success,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$BaseLoading<T> implements BaseLoading<T> {
  const _$BaseLoading({this.extra});
  ...
  @override
  String toString() {
    return 'BaseState<$T>.loading(extra: $extra)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  $BaseLoadingCopyWith<T, BaseLoading<T>> get copyWith =>
      _$BaseLoadingCopyWithImpl<T, BaseLoading<T>>(this, _$identity);
...
abstract class BaseLoading<T> implements BaseState<T> {
  const factory BaseLoading({Map<String, dynamic>? extra}) = _$BaseLoading<T>;
...
abstract class $BaseErrorCopyWith<T, $Res> {
  ...
  $Res call({String failure, Map<String, dynamic>? extra});
}
...
class _$BaseError<T> implements BaseError<T> {
  const _$BaseError(this.failure, {this.extra});
  ...
  @override
  String toString() {
    return 'BaseState<$T>.error(failure: $failure, extra: $extra)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(failure, extra);
  }
...
abstract class BaseError<T> implements BaseState<T> {
  const factory BaseError(String failure, {Map<String, dynamic>? extra}) =
      _$BaseError<T>;
...
abstract class $BaseSuccessCopyWith<T, $Res> {
  ...
  $Res call({T? data, Failure? failure, Map<String, dynamic>? extra});
}
...
class _$BaseSuccess<T> implements BaseSuccess<T> {
  const _$BaseSuccess({this.data, this.failure, this.extra});
  ...
  @override
  String toString() {
    return 'BaseState<$T>.success(data: $data, failure: $failure, extra: $extra)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return success(data, failure, extra);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(data, failure, extra);
  }
...
abstract class BaseSuccess<T> implements BaseState<T> {
  const factory BaseSuccess(
      {T? data,
      Failure? failure,
      Map<String, dynamic>? extra}) = _$BaseSuccess<T>;
